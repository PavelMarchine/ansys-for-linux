...
#include "ansysVtuSizing.H"
#include "ansysVtkCore.H"
#include "polyMesh.H"
#include "cellShape.H"
#include "manifoldCellsMeshObject.H"

// Only used in this file
#include "ansysVtuSizingImpl.C"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::vtk::vtuSizing::presizeMaps(ansysVtkMeshMaps& maps) const
{
