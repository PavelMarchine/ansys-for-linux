...
#include "ansysVtkOutput.H"

#include "ansysVtkFormatter.H"
#include "ansysVtkAsciiFormatter.H"
#include "ansysVtkBase64Formatter.H"
#include "ansysVtkAppendBase64Formatter.H"
#include "ansysVtkAppendRawFormatter.H"
#include "ansysVtkLegacyAsciiFormatter.H"
#include "ansysVtkLegacyRawFormatter.H"
...
)
{
    ...
    if (title.empty() || 0 == truncate)
    {
        ...
        os << "File generated by OpenFOAM " << ansysVersion::api << nl;
    }
