...
Foam::speciesTable& Foam::ansysChemistryReader<ThermoType>::setSpecies
(
...
template<class ThermoType>
void Foam::ansysChemistryReader<ThermoType>::readSpeciesComposition()
{
    wordList elems;
...
template<class ThermoType>
Foam::ansysChemistryReader<ThermoType>::ansysChemistryReader
(
...
:
    ...
    (
        IFstream
        (
            thermoDict.get<fileName>("ansysChemistryFile").expand()
        )()
    ),
    thermoDict_
    (
        IFstream
        (
            thermoDict.get<fileName>("ansysChemistryThermoFile").expand()
        )()
    ),
    speciesTable_(setSpecies(chemDict_, species)),
    speciesThermo_(thermoDict_),
