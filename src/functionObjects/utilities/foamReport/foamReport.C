...
{
    defineTypeNameAndDebug(ansysReport, 0);
    addToRunTimeSelectionTable(functionObject, ansysReport, dictionary);
}
}
...
void Foam::functionObjects::ansysReport::setStaticBuiltins()
{
    ...
    substitutionModel::addBuiltin("OF_API", ansysVersion::api);
    substitutionModel::addBuiltinStr("OF_PATCH", ansysVersion::patch);
    substitutionModel::addBuiltinStr("OF_BUILD", ansysVersion::build);
    substitutionModel::addBuiltinStr("OF_BUILD_ARCH", ansysVersion::buildArch);
    substitutionModel::addBuiltinStr("OF_VERSION", ansysVersion::version);
...
void Foam::functionObjects::ansysReport::setDynamicBuiltins()
{
...
bool Foam::functionObjects::ansysReport::parseTemplate(const fileName& fName)
{
...
bool Foam::functionObjects::ansysReport::apply(Ostream& os) const
{
...
Foam::functionObjects::ansysReport::ansysReport
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::ansysReport::read(const dictionary& dict)
{
...
bool Foam::functionObjects::ansysReport::execute()
{
...
bool Foam::functionObjects::ansysReport::write()
{
