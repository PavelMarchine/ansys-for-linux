...
{
    defineTypeName(ansysWriter);
    addToRunTimeSelectionTable(surfaceWriter, ansysWriter, word);
    addToRunTimeSelectionTable(surfaceWriter, ansysWriter, wordDict);
}
}
...
Foam::surfaceWriters::ansysWriter::ansysWriter()
:
    surfaceWriter(),
    streamOpt_()
{}
...
Foam::fileName Foam::surfaceWriters::ansysWriter::write()
{
    checkOpen();
...
template<class Type>
Foam::fileName Foam::surfaceWriters::ansysWriter::writeTemplate
(
...
defineSurfaceWriterWriteFields(Foam::surfaceWriters::ansysWriter);
