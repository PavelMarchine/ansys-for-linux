...
:
    ansysyHexMeshDict_(ansysyHexMeshDict)
{
    // Surface conformation controls

    const dictionary& surfDict
    (
        ansysyHexMeshDict_.subDict("surfaceConformation")
    );
    ...
    const dictionary& motionDict(ansysyHexMeshDict_.subDict("motionControl"));
    ...
    (
        ansysyHexMeshDict_.subDict("polyMeshFiltering")
    );
