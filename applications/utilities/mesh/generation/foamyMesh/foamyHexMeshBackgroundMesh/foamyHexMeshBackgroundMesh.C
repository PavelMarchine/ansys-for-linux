...
Application
    ansysyHexMeshBackGroundMesh

Description
    Writes out background mesh as constructed by ansysyHexMesh and constructs
    distanceSurface.
...
#include "ansysVtkSurfaceWriter.H"
#include "syncTools.H"
...
int main(int argc, char *argv[])
{
    argList::addNote
    (
        "Generate ansysyHexMesh-consistent representation of surfaces"
    );
    ...
    IOdictionary ansysyHexMeshDict
    (
        IOobject
        (
            "ansysyHexMeshDict",
    ...
    const dictionary& backgroundMeshDict =
        ansysyHexMeshDict.subDict("backgroundMeshDecomposition");
